...
local function set_hl_groups()
    local groups = {
        ...
        CursorLineNr = { bg = "#101012", fg = "#cdd1e6" },
        Delimiter = { fg = "#c6c8d1" },
        ...
        SignColumn = { bg = "#101012", fg = "#444b71" },
        Special = { fg = "#b4be82" },
